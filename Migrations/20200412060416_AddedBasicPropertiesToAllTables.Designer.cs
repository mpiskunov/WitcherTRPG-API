...
namespace WitcherTRPGWebApplication.Migrations
{
    ...
    [Migration("20200412060416_AddedBasicPropertiesToAllTables")]
    partial class AddedBasicPropertiesToAllTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CriticalLevel", b =>
                {
                    ...
                    b.Property<int>("BeatDefenseByValue")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.DefiningSkillTable", b =>
                {
                    ...
                    b.Property<string>("DefiningSkillFilter")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FirstColumnValue")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.FormulaeComponent", b =>
                {
                    ...
                    b.Property<int>("AlchemyCategory")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.GeneralGear", b =>
                {
                    ...
                    b.Property<int>("GeneralGearClassification")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.Ingredient", b =>
                {
                    ...
                    b.Property<int>("AlchemicalSubstanceID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.MountOutfit", b =>
                {
                    ...
                    b.Property<int>("MountOutfitClassification")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.Campaign", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CampaignCover", b =>
                {
                    ...
                    b.HasIndex("CommonCoverID");

                    b.ToTable("CampaignCovers");
                });

            modelBuilder.Entity("WitcherTRPG_API.Models.CampaignMonster", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CampaignMonsters");
                });

            modelBuilder.Entity("WitcherTRPG_API.Models.CampaignNote", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterBladeOil", b =>
                {
                    b.Property<int>("CharacterSheetID")
                        .HasColumnType("int");

                    b.Property<int>("BladeOilID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterMutagen", b =>
                {
                    ...
                    b.ToTable("CharacterMutagens");
                });

            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterWitcherDecoction", b =>
                {
                    b.Property<int>("CharacterSheetID")
                        .HasColumnType("int");

                    b.Property<int>("WitcherDecoctionID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CharacterWitcherDecoctions");
                });

            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterWitcherPotion", b =>
                {
                    b.Property<int>("CharacterSheetID")
                        .HasColumnType("int");

                    b.Property<int>("WitcherPotionID")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CharacterWitcherPotions");
                });
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.Mutagen", b =>
                {
                    ...
                    b.Property<string>("MinorMutation")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MutagenSource")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.Ingredient", b =>
                {
                    b.HasOne("WitcherTRPGWebApplication.Models.AlchemicalSubstance", "AlchemicalSubstance")
                        .WithMany()
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CampaignCover", b =>
                {
                    ...
                    b.HasOne("WitcherTRPGWebApplication.Models.CommonCover", "CommonCover")
                        .WithMany()
                        .HasForeignKey("CommonCoverID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterBladeOil", b =>
                {
                    b.HasOne("WitcherTRPG_API.Models.BladeOil", "BladeOil")
                        .WithMany()
                        .HasForeignKey("BladeOilID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterMutagen", b =>
                {
                    ...
                    b.HasOne("WitcherTRPG_API.Models.Mutagen", "Mutagen")
                        .WithMany()
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterWitcherDecoction", b =>
                {
                    ...
                    b.HasOne("WitcherTRPG_API.Models.WitcherDecoction", "WitcherDecoction")
                        .WithMany()
                        .HasForeignKey("WitcherDecoctionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WitcherTRPG_API.Models.CharacterWitcherPotion", b =>
                {
                    ...
                    b.HasOne("WitcherTRPG_API.Models.WitcherPotion", "WitcherPotion")
                        .WithMany()
                        .HasForeignKey("WitcherPotionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
