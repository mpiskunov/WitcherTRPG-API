...
namespace WitcherTRPGWebApplication.Migrations
{
    ...
    [Migration("20200209031330_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterArmorEffect", b =>
                {
                    ...
                    b.Property<int?>("CharacterArmorArmorID")
                        .HasColumnType("int");

                    b.Property<int?>("CharacterArmorCharacterSheetID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CharacterArmorID", "EffectID");

                    b.HasIndex("EffectID");

                    b.HasIndex("CharacterArmorCharacterSheetID", "CharacterArmorArmorID");

                    b.ToTable("CharacterArmorEffect");
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterArmorEnhancement", b =>
                {
                    ...
                    b.HasKey("CharacterSheetID", "ArmorEnhancementID");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterEffect", b =>
                {
                    ...
                    b.HasKey("CharacterSheetID", "EffectID");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterMountOutfit", b =>
                {
                    ...
                    b.Property<int>("CharacterMount_VehicleCharacterSheetID")
                        .HasColumnType("int");

                    b.Property<int>("CharacterMount_VehicleMounts_VehicleID")
                        .HasColumnType("int");

                    b.HasKey("CharacterMount_VehicleID", "MountOutfitID");

                    b.HasIndex("MountOutfitID");

                    b.HasIndex("CharacterMount_VehicleCharacterSheetID", "CharacterMount_VehicleMounts_VehicleID");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterMount_Vehicle", b =>
                {
                    ...
                    b.HasKey("CharacterSheetID", "Mounts_VehicleID");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterPriestInvocation", b =>
                {
                    b.Property<int>("CharacterSheetID")
                        .HasColumnType("int");

                    b.Property<int>("PriestInvocationID")
                        .HasColumnType("int");

                    b.HasKey("CharacterSheetID", "PriestInvocationID");

                    b.HasIndex("PriestInvocationID");

                    b.ToTable("CharacterPriestInvocations");
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterWeaponEffect", b =>
                {
                    ...
                    b.Property<int?>("CharacterWeaponCharacterSheetID")
                        .HasColumnType("int");

                    b.Property<int?>("CharacterWeaponWeaponID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CharacterWeaponID", "EffectID");

                    b.HasIndex("EffectID");

                    b.HasIndex("CharacterWeaponCharacterSheetID", "CharacterWeaponWeaponID");

                    b.ToTable("CharacterWeaponEffect");
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.PriestInvocation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.Ritual", b =>
                {
                    ...
                    b.Property<string>("AlternateComponents")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterArmor", b =>
                {
                    ...
                    b.HasOne("WitcherTRPGWebApplication.Models.EffectPackage", "EffectPackage")
                        .WithMany()
                        .HasForeignKey("EffectPackageID");
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterArmorEffect", b =>
                {
                    ...
                    b.HasOne("WitcherTRPGWebApplication.Models.CharacterArmor", "CharacterArmor")
                        .WithMany()
                        .HasForeignKey("CharacterArmorCharacterSheetID", "CharacterArmorArmorID");
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterMountOutfit", b =>
                {
                    ...
                    b.HasOne("WitcherTRPGWebApplication.Models.CharacterMount_Vehicle", "CharacterMount_Vehicle")
                        .WithMany()
                        .HasForeignKey("CharacterMount_VehicleCharacterSheetID", "CharacterMount_VehicleMounts_VehicleID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterPriestInvocation", b =>
                {
                    ...
                    b.HasOne("WitcherTRPGWebApplication.Models.PriestInvocation", "PriestInvocation")
                        .WithMany()
                        .HasForeignKey("PriestInvocationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WitcherTRPGWebApplication.Models.CharacterWeaponEffect", b =>
                {
                    ...
                    b.HasOne("WitcherTRPGWebApplication.Models.CharacterWeapon", "CharacterWeapon")
                        .WithMany()
                        .HasForeignKey("CharacterWeaponCharacterSheetID", "CharacterWeaponWeaponID");
                });
